...
pub mod vulnerabilities_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get_workload_vulnerabilities(
            &mut self,
            request: impl tonic::IntoRequest<super::WorkloadRequest>,
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/vulnerabilities.Vulnerabilities/GetWorkloadVulnerabilities",
            );
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/vulnerabilities.Vulnerabilities/GetWorkloadVulnerabilities" => {
                    ...
                    struct GetWorkloadVulnerabilitiesSvc<T: Vulnerabilities>(pub Arc<T>);
                    impl<
                        T: Vulnerabilities,
                    > tonic::server::UnaryService<super::WorkloadRequest>
                    for GetWorkloadVulnerabilitiesSvc<T> {
                        type Response = super::WorkloadReply;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Vulnerabilities>::get_workload_vulnerabilities(
                                        &inner,
                                        request,
                                    )
                                    .await
