...
pub struct StatCountRequest {}
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
pub struct StatCountReply {
    #[prost(uint64, tag = "1")]
    pub count: u64,
}
...
pub mod admin_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get_stat_count(
            &mut self,
            request: impl tonic::IntoRequest<super::StatCountRequest>,
        ) -> std::result::Result<tonic::Response<super::StatCountReply>, tonic::Status> {
            self.inner
                .ready()
                .await
                .map_err(|e| {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/helloworld.Admin/GetStatCount",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("helloworld.Admin", "GetStatCount"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod admin_server {
    ...
    pub trait Admin: std::marker::Send + std::marker::Sync + 'static {
        async fn get_stat_count(
            &self,
            request: tonic::Request<super::StatCountRequest>,
        ) -> std::result::Result<tonic::Response<super::StatCountReply>, tonic::Status>;
    }
    #[derive(Debug)]
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/helloworld.Admin/GetStatCount" => {
                    #[allow(non_camel_case_types)]
                    struct GetStatCountSvc<T: Admin>(pub Arc<T>);
                    impl<T: Admin> tonic::server::UnaryService<super::StatCountRequest>
                    for GetStatCountSvc<T> {
                        type Response = super::StatCountReply;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Admin>::get_stat_count(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetStatCountSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "helloworld.Admin";
