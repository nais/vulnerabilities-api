...
pub struct PortfolioMetrics {
    ...
    #[serde(rename = "vulnerableProjects", skip_serializing_if = "Option::is_none")]
    pub vulnerable_projects: Option<i32>,
...
impl PortfolioMetrics {
    pub fn new(critical: i32, high: i32, medium: i32, low: i32, first_occurrence: f64, last_occurrence: f64) -> PortfolioMetrics {
        PortfolioMetrics {
            critical,
            high,
            medium,
