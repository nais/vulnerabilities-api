# Rust API client for dependencytrack
...
Put the package under your project folder in a directory named `dependencytrack` and add the following to `Cargo.toml` under `[dependencies]`:
